    ...
    public partial class dificil : Form
    {
        ...
        public void verificar()
        {
            if (button1.Text == "1" && button2.Text == "2" && button3.Text == "3"
                ...
                && button25.Text == "25" && button26.Text == "26" && button27.Text == "27" && button28.Text == "28"
                && button29.Text == "29" && button30.Text == "30" && button31.Text == "31" && button32.Text == "32"
                && button33.Text == "33" && button34.Text == "34" && button35.Text == "35" && button36.Text == "")
            {
